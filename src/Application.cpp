...
int main(void)
{
	...
	Shader lightingShader("shaders/vertex/multipleLights.vs", "shaders/fragment/multipleLights.fs");
	...
	//unsigned int emissionMap = loadTexture("res/textures/box.png"); //unassigned
